...
Use this reference when creating a new assignment.

## Checklist

- Define a clear learning objective.
- Include student-friendly instructions.
- Provide starter code when needed.
- Add expected output or success criteria.
